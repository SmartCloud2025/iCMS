...
<link rel="stylesheet" href="<?php echo iCMS_UI;?>/font-awesome-4.0.3/css/font-awesome.min.css" type="text/css" />
<link rel="stylesheet" href="<?php echo iCMS_UI;?>/jquery/uniform-2.1.2.min.css" type="text/css" />
<link rel="stylesheet" href="<?php echo iCMS_UI;?>/jquery/chosen-1.0.0.min.css" type="text/css" />
...
<link rel="stylesheet" href="<?php echo iCMS_UI;?>/admincp-6.0.0.css" type="text/css" />
<script type="text/javascript" src="<?php echo iCMS_UI;?>/jquery/jquery-1.11.0.min.js"></script>
<script type="text/javascript" src="<?php echo iCMS_UI;?>/jquery/migrate-1.2.1.js"></script>
<script type="text/javascript" src="<?php echo iCMS_UI;?>/jquery/scrollUp-1.1.0.min.js"></script>
<script type="text/javascript" src="<?php echo iCMS_UI;?>/jquery/uniform-2.1.2.min.js"></script>
<script type="text/javascript" src="<?php echo iCMS_UI;?>/jquery/chosen-1.0.0.js"></script>
...
<script type="text/javascript" src="<?php echo iCMS_UI;?>/bootstrap-2.3.1/js/bootstrap.min.js"></script>
<script type="text/javascript" src="<?php echo iCMS_UI;?>/bootstrap-2.3.1/js/bootstrap-datepicker.js"></script>
<script type="text/javascript" src="<?php echo iCMS_UI;?>/bootstrap-2.3.1/js/bootstrap-switch.min.js"></script>
<script type="text/javascript" src="<?php echo iCMS_UI;?>/iCMS-6.0.0.js"></script>
<script type="text/javascript" src="<?php echo iCMS_UI;?>/admincp-6.0.0.js"></script>
<script type="text/javascript">
window.iCMS.DIR		= "/<?php echo trim(iCMS::$config['router']['DIR'],'/');?>/";
window.iCMS.APP		= "<?php echo __ADMINCP__;?>";
window.iCMS.UI		= "<?php echo iCMS_UI;?>";
...
<div id="iPHP_DIALOG" title="iPHP提示" class="hide"><img src="<?php echo iCMS_UI;?>/loading.gif" /></div>
<div id="iCMS_MODAL" class="modal hide">
  ...
  <div class="modal-body">
    <p><img src="<?php echo iCMS_UI;?>/loading.gif" /></p>
  </div>
</div>
