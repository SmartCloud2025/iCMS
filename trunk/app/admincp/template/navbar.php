...
<div id="header" class="navbar navbar-static-top">
  <div class="navbar-inner">
    <a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse"> <span class="fa fa-bars"></span> </a> <a class="brand iCMS-logo" href="http://www.idreamsoft.com" target="_blank"><img src="<?php echo iCMS_UI;?>/iCMS.logo-6.0.png" /></a>
        ...
        <ul class="nav pull-right">
          ...
          <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-users"></i> <?php echo iMember::$group->name;?> <b class="caret"></b></a>
            <ul class="dropdown-menu">
              <li><a href="###"><?php echo iMember::$Rs->username;?></a></li>
              <li class="divider"></li>
...
<div id="sidebar" class="navbar">
	<div id="sidebartop" class="navbar-inner"><a class="brand iCMS-logo" href="http://www.idreamsoft.com" target="_blank"><img src="<?php echo iCMS_UI;?>/iCMS.logo-6.0.png" /></a></div>
  <ul>
