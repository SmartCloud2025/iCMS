(function($) {
    iCMS.comment = {
        page: function(pn, a) {
            ...
            var url = iCMS.config.API+'?'+query+'&pn='+pn;
            $.get(url,function(html){
                var box = $(".commentApp-box",$(html)).html(),
                pagination = $(".iCMS-pagination",$(html)).html();
                $(".commentApp-box",pp).html(box);
                $(".iCMS-pagination",pp).html(pagination);
            });
        },
        box: function(a) {
            var $this = $(a),
                    ...
                    function(json) {
                        ...
                        $.each(json, function(i, c) {
                            ...
                            item += '</div>' +
                                ...
                                '<a href="javascript:;" class="reply commentApp-op-link" name="reply_comment" data-param=\'{"id":"' + c.id + '","uid":"' + c.user.uid + '","name":"' + c.user.name + '"}\'>' +
